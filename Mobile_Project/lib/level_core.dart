...
void main() {
  runApp(const level_core());
}

class level_core extends StatelessWidget {
  const level_core({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => core_easy()),
                      );
                    },
                    child: Container(
                      width: 416,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => core_medium()),
                      );
                    },
                    child: Container(
                      width: 416,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => core_hard()),
                      );
                    },
                    child: Container(
                      width: 416,
