        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child:
                  Image.asset('assets/gif/chest/hard1.gif'), // ใช้ GIF แทนภาพปก
            ),
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:
                Image.asset('assets/gif/chest/hard2.gif'), // ใช้ GIF แทนภาพปก
          ),
          const SizedBox(height: 10),
          const Text(
            'Chest Press',
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:
                Image.asset('assets/gif/chest/hard3.gif'), // ใช้ GIF แทนภาพปก
          ),
          const SizedBox(height: 10),
          const Text(
            'Frog Pump',
