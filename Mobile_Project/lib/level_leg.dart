...
void main() {
  runApp(const level_leg());
}

class level_leg extends StatelessWidget {
  const level_leg({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => leg_easy()),
                      );
                    },
                    child: Container(
                      width: 416,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => leg_medium()),
                      );
                    },
                    child: Container(
                      width: 416,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => leg_hard()),
                      );
                    },
                    child: Container(
                      width: 416,
