        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child:
                  Image.asset('assets/gif/arm/medium1.gif'), // ใช้ GIF แทนภาพปก
            ),
            const SizedBox(height: 10),
            const Text(
              'Lying Single-Arm Cross-Body ',
              style: TextStyle(
                fontFamily: 'Baloo',
                color: Colors.black,
                fontSize: 25,
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:
                Image.asset('assets/gif/arm/medium2.gif'), // ใช้ GIF แทนภาพปก
          ),
          const SizedBox(height: 10),
          const Text(
            'Dumbbell Overhead',
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:
                Image.asset('assets/gif/arm/medium3.gif'), // ใช้ GIF แทนภาพปก
          ),
          const SizedBox(height: 10),
          const Text(
